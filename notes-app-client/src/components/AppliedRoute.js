...
/** This component creates a Route where the child component that it renders contains the passed in props.
  ...
  * The Route component takes a prop called `ComponentToBeRendered` that represents the component that will be rendered when a matching route is found. We want our childProps to be sent to this component.
  ...
  * Finally, we take component (set as ComponentToBeRendered) and props (set as cProps) and render inside our Route. Note, the `props` variable in this case is what the Route component passes us. Whereas, the `cProps` is the childProps that we want to set.
